...
def train_and_save_logistic_regression(dataset_path="data/breast-cancer-wisconsin-data.csv", save_path="saved_models/logistic_regression.pkl"):
...
def load_logistic_regression(save_path="saved_models/logistic_regression.pkl"):
