...
def train_and_save_decision_tree(dataset_path="data/breast-cancer-wisconsin-data.csv", save_path="saved_models/decision_tree.pkl"):
...
def load_decision_tree(save_path="saved_models/decision_tree.pkl"):
